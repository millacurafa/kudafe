...
previouse_page <-  google_analytics(viewid, 
                 ...
                 dimensions = c("ga:pageTitle",
                                ...
                                "ga:previousPagePath"),
                filters="ga:pagePath=~/webinars/" ) %>% clean_names() %>% 
  separate(previous_page_path,into = c("url","after_?"),sep = "[?]") 
```
```{r}
...
landing_page <-  google_analytics(viewid, 
                 ...
                 dimensions = c("ga:pageTitle",
                                ...
                                "ga:landingPagePath"),
                filters="ga:pagePath=~/webinars/" ) %>% clean_names() %>% 
  separate(landing_page_path,into = c("url","after_?"),sep = "[?]") 
...
all_pages_title <- google_analytics(viewid, 
                 ...
                 dimensions = c(
                                "pagePath",
                                "pageTitle")) %>% clean_names() %>% 
    separate(page_path,into = c("url","after_?"),sep = "[?]") 
